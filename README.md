...
This site contains exercises for the course GEOV181, Introduction to earth science and informatics. These exercises belong to the third module of GEOV181 to process your collected rain data. You do not have to use the provided code, you can make your own, but it might be helpfull. Be aware, I added some small mistakes in the code, so you will need to read the code and fix them if you use [this code](http://colab.research.google.com/github/JosseBerg/blob/main/GEOV181_2025_Rain_station.ipynb).
